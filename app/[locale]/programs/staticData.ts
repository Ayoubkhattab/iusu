...
export const programsIntroData: Record<string, ProgramIntro> = {
  ...
  qraat: {
    id: "qraat",
    title: "المعهد التخصصي للقراءات وعلوم القرآن الكريم",
    description:
      "هو معهد علمي يختص بتأهيل قراء بالقراءات العشر؛ وذلك بالجمع بين الرواية (والقراءة على الشيوخ) والدراية (الدراسة الأكاديمية التأصيلية)؛ لتحقيق الكفاءة والتميز في مجال تعلم القرآن العظيم وتعليمه.",
    vision:
      "أن يكون المعهد منارة معرفية، ومرجعية رائدة متميزة، في تعليم القرآن الكريم وعلومه.",
    mission:
      "نشر علوم السنة ورفع كفاءة البحث العلمي فيها، وإعداد متخصصين مؤهلين في علوم الحديث النبوي.",
    goals: [
      "تأهيل كفاءات عالية في علم القراءات، تتميز بالجمع بين الرواية والدراية.",
      "رفد المساجد والجامعات والمعاهد القرآنية بالمقرئين المختصين والمتميزين",
      "	بناء مرجعية موثوقة في مجال الإقراء وعلم القراءات.",
      "	تقديم نموذج رائد للمعاهد القرآنية في المحرر، ليكون مثالاً يحتذى به",
      "	نشر علم القراءات والحفاظ على التنزيل الكريم من التحريف والتشويه.",
      "	إيجاد صرح يأوي إليه كل من يرغب بالتميز في علم القراءات من طلاب المعاهد القرآنية وحلقات التحفيظ.",
    ],
    values: [],
    subjects: ["مواد تأصيلية شرعية مشتركة", "مواد تخصصية", "مواد مساعدة"],
  },
